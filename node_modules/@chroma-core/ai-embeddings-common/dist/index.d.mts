...
declare const schemaMap: {
    ...
    mistral: Schema;
    morph: Schema;
    "chroma-cloud-qwen": Schema;
    "chroma-cloud-splade": Schema;
    chroma_bm25: Schema;
    perplexity: Schema;
};
/**
 ...
 */
declare function decodeBase64Embedding(b64String: string): number[];
declare const snakeCase: (input: any) => any;
declare const isBrowser: () => boolean;

export { decodeBase64Embedding, getAvailableSchemas, getSchemaInfo, getSchemaVersion, isBrowser, loadSchema, snakeCase, validateConfigSchema };
